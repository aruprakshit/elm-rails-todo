...
var author$project$Main$ActivatedLink = function (a) {
	return {$: 'ActivatedLink', a: a};
};
...
var author$project$Decoders$Flags$decodeFlags = function (json) {
...
var author$project$Config$backendDomain = 'http://localhost:5000';
...
var author$project$Decoders$Todos$todoDecoder = A5(
	elm$json$Json$Decode$map4,
	author$project$Entities$Todo$Model,
...
var author$project$Navigation$Index = {$: 'Index'};
var author$project$Navigation$Login = {$: 'Login'};
var author$project$Navigation$New = {$: 'New'};
var author$project$Navigation$Show = function (a) {
	return {$: 'Show', a: a};
};
...
var author$project$Navigation$route = elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			A2(elm$url$Url$Parser$map, author$project$Navigation$Index, elm$url$Url$Parser$top),
			A2(
			elm$url$Url$Parser$map,
			author$project$Navigation$New,
			A2(
				elm$url$Url$Parser$slash,
				elm$url$Url$Parser$s('todos'),
				elm$url$Url$Parser$s('new'))),
			A2(
			elm$url$Url$Parser$map,
			author$project$Navigation$Edit,
			A2(
				elm$url$Url$Parser$slash,
				elm$url$Url$Parser$s('todos'),
				A2(
			...
			A2(
			elm$url$Url$Parser$map,
			author$project$Navigation$Show,
			A2(
				elm$url$Url$Parser$slash,
				elm$url$Url$Parser$s('todos'),
				elm$url$Url$Parser$int)),
...
var author$project$Navigation$toRoute = function (url) {
	var _n0 = elm$url$Url$fromString(url);
	if (_n0.$ === 'Nothing') {
		return author$project$Navigation$NotFound;
	} else {
		var uri = _n0.a;
		return A2(
			elm$core$Maybe$withDefault,
			author$project$Navigation$NotFound,
		...
		switch (_n0.$) {
			...
			case 'New':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							state: author$project$Main$NewTodo(author$project$Entities$Todo$initialModel)
						}),
			...
			default:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{state: author$project$Main$NoPageFound}),
					elm$core$Platform$Cmd$none);
		}
	});
...
var author$project$Main$init = F3(
	function (flags, url, navKey) {
		...
		if (_n0.$ === 'Just') {
			var authToken = _n0.a;
			return A2(
				author$project$Main$getCurrentPageData,
				A2(
...
var author$project$Main$NewTodoPageMsg = function (a) {
	return {$: 'NewTodoPageMsg', a: a};
};
	...
	function (config, msg, model) {
		switch (msg.$) {
			...
			default:
				var todoid = msg.a;
				var response = msg.b;
				var id = elm$core$String$toInt(todoid);
				var _n2 = _Utils_Tuple2(id, response);
				if ((_n2.a.$ === 'Just') && (_n2.b.$ === 'Ok')) {
					var number = _n2.a.a;
					return _Utils_Tuple2(
						A2(
...
var author$project$Page$Todos$Edit$UpdatedTodo = function (a) {
	...
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'title',
				elm$json$Json$Encode$string(formData.title)),
				_Utils_Tuple2(
				'content',
				elm$json$Json$Encode$string(
					A2(elm$core$Maybe$withDefault, '', formData.content))),
				_Utils_Tuple2(
				'completed',
...
var author$project$Utils$Todo$idToString = function (number) {
	return A2(
		elm$core$Maybe$withDefault,
		'',
					...
					A2(
						...
						A2(
							...
							_List_fromArray(
								[
									'todos',
									author$project$Utils$Todo$idToString(model.id)
								]),
							_List_Nil)));
		}
	});
var author$project$Page$Todos$New$CreatedTodo = function (a) {
	return {$: 'CreatedTodo', a: a};
};
var author$project$Page$Todos$New$todoPayload = function (formData) {
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
			...
			switch (_n0.a.$) {
				case 'EditTodoPageMsg':
					if (_n0.b.$ === 'EditTodo') {
						...
						return A2(
							...
							elm$core$Platform$Cmd$map(author$project$Main$EditTodoPageMsg),
							A2(
								...
								function (newTodo) {
									return _Utils_update(
										model,
										{
											state: author$project$Main$EditTodo(
												elm$core$Maybe$Just(newTodo))
										});
								},
								A3(
				...
				case 'HomePageMsg':
					if (_n0.b.$ === 'Home') {
						...
						return A2(
							elm$core$Tuple$mapSecond,
							elm$core$Platform$Cmd$map(author$project$Main$HomePageMsg),
							A2(
								elm$core$Tuple$mapFirst,
								function (newTodos) {
									return _Utils_update(
				...
				case 'NewTodoPageMsg':
					if (_n0.b.$ === 'NewTodo') {
						...
						var currentTodo = _n0.b.a;
						return A2(
							elm$core$Tuple$mapSecond,
							elm$core$Platform$Cmd$map(author$project$Main$NewTodoPageMsg),
							A2(
								elm$core$Tuple$mapFirst,
								function (newTodo) {
									return _Utils_update(
				...
				case 'ActivatedLink':
					...
					if (urlContainer.$ === 'Internal') {
						var url = urlContainer.a;
						return _Utils_Tuple2(
							model,
							A2(elm$browser$Browser$Navigation$pushUrl, model.key, url.path));
					} else {
						var path = urlContainer.a;
						return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
					}
				case 'ChangedUrl':
					var url = _n0.a.a;
					return A2(author$project$Main$getCurrentPageData, model, url);
				case 'GotTodo':
							...
							case 'ShowTodo':
								return _Utils_Tuple2(
									_Utils_update(
										model,
										{
											state: author$project$Main$ShowTodo(
					...
					if (response.$ === 'Ok') {
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									state: author$project$Main$Home(todos)
								}),
							elm$core$Platform$Cmd$none);
					} else {
						return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('col-6 m-auto')
					]),
				_List_fromArray(
					[
						A2(
									...
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														elm$html$Html$Attributes$for('sign-in-email')
													]),
												_List_fromArray(
													[
												...
												_List_fromArray(
													[
														...
														elm$html$Html$Attributes$id('sign-in-email'),
														elm$html$Html$Events$onInput(
														author$project$Page$Auth$Sessions$OnInputChange('email')),
									...
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														elm$html$Html$Attributes$for('sign-in-password')
													]),
												_List_fromArray(
													[
												...
												_List_fromArray(
													[
														...
														elm$html$Html$Attributes$class('form-control'),
														elm$html$Html$Attributes$id('sign-in-password'),
														elm$html$Html$Events$onInput(
														author$project$Page$Auth$Sessions$OnInputChange('password')),
...
var author$project$Page$Home$ChangeFilter = function (a) {
	return {$: 'ChangeFilter', a: a};
};
var elm$html$Html$option = _VirtualDom_node('option');
var elm$html$Html$select = _VirtualDom_node('select');
var author$project$Page$Home$tableFilter = A2(
...
var author$project$Page$NotFound$view = A2(
	...
	_List_fromArray(
		[
			elm$html$Html$Attributes$id('notfound')
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('notfound-404')
						]),
					_List_fromArray(
						[
							A2(
					...
					_List_fromArray(
						[
							elm$html$Html$text('Oops! This Page Could Not Be Found')
						])),
					A2(
					elm$html$Html$p,
					_List_Nil,
					_List_fromArray(
						[
							elm$html$Html$text('Sorry but the page you are looking for does not exist, have been removed. name changed or is temporarily unavailable')
						])),
					A2(
					elm$html$Html$a,
					_List_fromArray(
					...
					_List_fromArray(
						[
							elm$html$Html$text('Go To Homepage')
						]))
				]))
		]));
var author$project$Page$Todos$Edit$OnCheckChange = F2(
	function (a, b) {
		return {$: 'OnCheckChange', a: a, b: b};
	});
var author$project$Page$Todos$Edit$OnInputChange = F2(
	function (a, b) {
		return {$: 'OnInputChange', a: a, b: b};
	});
var author$project$Page$Todos$Edit$UpdateTodo = {$: 'UpdateTodo'};
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text(
						'Editing Todo #' + author$project$Utils$Todo$idToString(model.id))
					])),
				A2(
				elm$html$Html$form,
				_List_fromArray(
					[
						elm$html$Html$Events$onSubmit(author$project$Page$Todos$Edit$UpdateTodo)
					]),
				_List_fromArray(
					[
						A2(
									...
									[
										...
										_List_fromArray(
											[
												...
												elm$html$Html$Events$onInput(
												author$project$Page$Todos$Edit$OnInputChange('title'))
											]),
										_List_Nil)
									]))
							])),
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												elm$html$Html$Attributes$placeholder('Content'),
												A2(elm$html$Html$Attributes$style, 'margin-left', '10px'),
												elm$html$Html$Attributes$value(
												A2(elm$core$Maybe$withDefault, '', model.content)),
												elm$html$Html$Events$onInput(
												author$project$Page$Todos$Edit$OnInputChange('content'))
											]),
										_List_Nil)
									]))
							])),
									...
									[
										...
										_List_fromArray(
											[
												...
												A2(elm$html$Html$Attributes$style, 'margin-left', '10px'),
												elm$html$Html$Attributes$checked(model.completed),
												elm$html$Html$Events$onCheck(
												author$project$Page$Todos$Edit$OnCheckChange('completed'))
											]),
										_List_Nil)
									]))
							])),
...
var author$project$Page$Todos$New$CreateTodo = {$: 'CreateTodo'};
var author$project$Page$Todos$New$OnInputChange = F2(
	function (a, b) {
		return {$: 'OnInputChange', a: a, b: b};
	});
var author$project$Page$Todos$New$view = function (model) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Events$onSubmit(author$project$Page$Todos$New$CreateTodo)
					]),
				_List_fromArray(
					[
						A2(
									...
									[
										...
										_List_fromArray(
											[
												...
												elm$html$Html$Attributes$value(model.title),
												elm$html$Html$Events$onInput(
												author$project$Page$Todos$New$OnInputChange('title'))
											]),
										_List_Nil)
									]))
							])),
									...
									[
										...
										_List_fromArray(
											[
												...
												A2(elm$core$Maybe$withDefault, '', model.content)),
												elm$html$Html$Events$onInput(
												author$project$Page$Todos$New$OnInputChange('content'))
											]),
										_List_Nil)
									]))
							])),
...
var author$project$Page$Todos$Show$view = function (model) {
	var content = function () {
		if (model.$ === 'Just') {
			var todo = model.a;
			return author$project$Page$Todos$Show$todoView(todo);
		} else {
...
var author$project$Main$pageBody = function (_n0) {
	var key = _n0.key;
	var state = _n0.state;
	var body = function () {
		switch (state.$) {
...
var author$project$Main$main = elm$browser$Browser$application(
	{init: author$project$Main$init, onUrlChange: author$project$Main$ChangedUrl, onUrlRequest: author$project$Main$ActivatedLink, subscriptions: author$project$Main$subscriptions, update: author$project$Main$update, view: author$project$Main$view});
